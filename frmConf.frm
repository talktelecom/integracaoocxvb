...
'  Exit Sub
'End If
'  Call frmInicial.Atendimento_Button1.met_Cancela_Conf
'Else
'  Call frmInicial.Atendimento_Button1.met_Encerrar_Conf(0)
'  Call frmInicial.Atendimento_Button1.met_Encerrar_Conf(1)
'  Call frmInicial.Atendimento_Button1.met_Cancela_Conf
'End If
...
For i = 1 To lvwConf.ListItems.Count
  ...
  If Len(strNum) = 3 Then
    Call frmInicial.Atendimento_Button1.met_Adicionar_Conf(Trim(strNum), 0)
  Else
    Call frmInicial.Atendimento_Button1.met_Adicionar_Conf(Trim(strNum), 1)
    Call frmInicial.Atendimento_Button1.met_Adicionar_Numero_Conf(Trim(strNum), "x")
    iExterno = 1
  End If
Next

Call frmInicial.Atendimento_Button1.met_Iniciar_Conf(0)
